...
export default function RecipesPage() {
  ...
  // Filter ONLY by recipeName (tên món ăn)
    ...
    <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
      <header className="mb-10 max-w-2xl">
        ...
        <p className="mt-3 text-lg leading-relaxed text-muted-foreground text-pretty">
          Tìm kiếm theo tên món ăn và lưu lại những công thức bạn muốn thử.
        </p>
      </header>
      ...
      <div className="mb-8 flex flex-col gap-3 sm:flex-row">
        <div className="relative flex-1">
          ...
          <Input
            ...
            placeholder="Nhập tên món ăn (vd: Phở bò, Cơm tấm, Bún bò...)..."
      ...
      {isLoading ? (
        ...
        <div className="flex flex-col items-center justify-center gap-4 rounded-2xl border border-dashed border-border py-20 text-center">
          ...
          <div>
            <p className="font-serif text-lg font-semibold">Không tìm thấy món ăn &quot;{term}&quot;</p>
            <p className="mt-1 text-sm text-muted-foreground">Vui lòng kiểm tra lại tên món ăn hoặc bấm xóa để xem tất cả.</p>
          </div>
          {term && (
